...
function preload(){
    ...
    //Adjust the images for jump and knife depending on requirement
    knifeImg = loadAnimation("images/knife1.png","images/knife3.png","images/knife4.png",);
...
function draw(){
    ...
    if(gameState === "howPlay"){
        ...
        //Instead of creating a separate button to adjust in how to play.. use the same play button itself as the logic is same.
    ...
    if(gameState === "game"){
        ...
        //USe keywend down and key went up to add and vhange the animation back to what we need
